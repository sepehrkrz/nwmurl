...
class TestGenerateURLs(unittest.TestCase):
    def test_generate_urls_operational_for_forcing_analysis_assim_hawaii(self):
        ...
        expected_urls = [
            "https://nomads.ncep.noaa.gov/pub/data/nccf/com/nwm/post-processed/WMS/nwm.20220112/forcing_analysis_assim_hawaii/nwm.t00z.analysis_assim.forcing.tm001.hawaii.nc",
            "https://nomads.ncep.noaa.gov/pub/data/nccf/com/nwm/post-processed/WMS/nwm.20220112/forcing_analysis_assim_hawaii/nwm.t00z.analysis_assim.forcing.tm018.hawaii.nc",
            "https://nomads.ncep.noaa.gov/pub/data/nccf/com/nwm/post-processed/WMS/nwm.20220112/forcing_analysis_assim_hawaii/nwm.t08z.analysis_assim.forcing.tm001.hawaii.nc",
            "https://nomads.ncep.noaa.gov/pub/data/nccf/com/nwm/post-processed/WMS/nwm.20220112/forcing_analysis_assim_hawaii/nwm.t08z.analysis_assim.forcing.tm018.hawaii.nc",
